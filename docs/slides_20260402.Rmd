...
Everything for FIMS lives in one shared place, making it is easy to find the code, follow discussions, and jump in.

1. **We use a GitHub Discussion board as the main community hub**
   1. .hyperlink-style[https://github.com/orgs/NOAA-FIMS/discussions]
   2. In place of Slack, Discord, or Google Group
   3. &#x1F9ED; Trace decisions from Discussion &#x2192; Issue &#x2192; PR
   4. &#x1F44B; Introduce yourself on .hyperlink-style[[Discussion #801](https://github.com/orgs/NOAA-FIMS/discussions/801)]
...
1. **We use a GitHub Discussion board as the main community hub**
   ...
   3. &#x1F9ED; Trace decisions from Discussion &#x2192; Issue &#x2192; PR
   4. &#x1F44B; Introduce yourself on .hyperlink-style[[Discussion #801](https://github.com/orgs/NOAA-FIMS/discussions/801)]
2. **Explore the GitHub organization**
...
---
# FIMS package <img src="static/FIMS_hexlogo.png" style="width: 100%; max-width: 50px;" />
...
<div class="priority-grid">
  ...
  <div class="priority-card priority-card--accent">
    ...
    <div>
      ...
      <div class="priority-detail">Allow for discarded fisheries.</div>
    </div>
  </div>
</div>
...
### &#x1F449; Join now and help shape what FIMS builds next.
